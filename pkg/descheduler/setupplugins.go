...
func RegisterDefaultPlugins(registry pluginregistry.Registry) {
	...
	pluginregistry.Register(nodeutilization.HighNodeUtilizationCordonerPluginName, nodeutilization.NewHighNodeUtilizationCordoner, &nodeutilization.HighNodeUtilizationCordoner{}, &nodeutilization.HighNodeUtilizationCordonerArgs{}, nodeutilization.ValidateHighNodeUtilizationCordonerArgs, nodeutilization.SetDefaults_HighNodeUtilizationCordonerArgs, registry)
